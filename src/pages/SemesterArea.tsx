...
const areaData: AreaData[] = [
  ...
  { id: 2, name: 'Computer' },
  { id: 3, name: 'Cultural' },
  { id: 4, name: 'Everyday Practical Living' },
  { id: 5, name: 'Islamic' },
  { id: 6, name: 'Language' },
  { id: 7, name: 'Math' },
  { id: 8, name: 'Music' },
  { id: 9, name: 'PE' },
  { id: 10, name: 'Sensorial' },
];

// Sample data for sub areas
const subAreaData: SubAreaData[] = [
  { id: 1, name: 'Visual Discrimination', areaId: 10 },
  { id: 2, name: 'Tactile Discrimination', areaId: 10 },
  { id: 3, name: 'Auditory Discrimination', areaId: 10 },
  { id: 4, name: 'Olfactory Discrimination', areaId: 10 },
  { id: 5, name: 'Gustatory Discrimination', areaId: 10 },
  { id: 6, name: 'Writing', areaId: 6 },
  { id: 7, name: 'Reading', areaId: 6 },
  { id: 8, name: 'Oral Language', areaId: 6 },
  { id: 9, name: 'Quantities and Numerals 1-10', areaId: 7 },
  { id: 10, name: 'Decimal System', areaId: 7 },
];

// Sample data for competencies
const competencyData: CompetencyData[] = [
  { id: 1, name: 'Matching and sorting', subAreaId: 1 },
  { id: 2, name: 'Seriating based on size and dimension', subAreaId: 1 },
  { id: 3, name: 'Seriating based on size and dimension', subAreaId: 1 },
  { id: 4, name: 'Seriating based on size and dimension', subAreaId: 1 },
  { id: 5, name: 'Seriating based on size and dimension', subAreaId: 1 },
  { id: 6, name: 'Matching colours', subAreaId: 1 },
  { id: 7, name: 'Matching colours', subAreaId: 1 },
  { id: 8, name: 'Recognizes and identifies primary colours', subAreaId: 1 },
  { id: 9, name: 'Recognizes and identifies tertiary colours and tones', subAreaId: 1 },
  { id: 10, name: 'Grading colours from lightest to darkest', subAreaId: 1 },
];
        ...
        <div className="p-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Semester Area</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <Card>
            <CardHeader className="bg-emerald-700 text-white rounded-t-md py-4">
              <CardTitle className="text-base font-medium">Semester Area Data</CardTitle>
            </CardHeader>
            <CardContent className="p-0">
